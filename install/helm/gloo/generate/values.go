...
type GlooDeployment struct {
	...
	ExtraGlooLabels        interface{} `json:"extraGlooLabels" desc:"Optional extra key-value pairs to add to the metadata.labels data of the primary gloo pod."`
	*DeploymentSpec
}
...
type DiscoveryDeployment struct {
	...
	FloatingUserId       bool        `json:"floatingUserId" desc:"set to true to allow the cluster to dynamically assign a user ID"`
	RunAsUser            float64     `json:"runAsUser" desc:"Explicitly set the user ID for the container to run as. Default is 10101"`
	ExtraDiscoveryLabels interface{} `json:"extraDiscoveryLabels" desc:"Optional extra key-value pairs to add to the metadata.labels data of the gloo discovery pod."`
	*DeploymentSpec
}
...
type GatewayDeployment struct {
	...
	FloatingUserId     bool        `json:"floatingUserId" desc:"set to true to allow the cluster to dynamically assign a user ID"`
	RunAsUser          float64     `json:"runAsUser" desc:"Explicitly set the user ID for the container to run as. Default is 10101"`
	ExtraGatewayLabels interface{} `json:"extraGatewayLabels" desc:"Optional extra key-value pairs to add to the metadata.labels data of the gloo gateway pod."`
	*DeploymentSpec
}
...
type GatewayProxyPodTemplate struct {
	...
	ExtraGatewayProxyLabels       interface{}           `json:"extraGatewayProxyLabels" desc:"Optional extra key-value pairs to add to the metadata.labels data of the gloo gateway proxy pod."`
}
...
type AccessLogger struct {
	...
	RunAsUser               float64     `json:"runAsUser" desc:"Explicitly set the user ID for the container to run as. Default is 10101"`
	FsGroup                 float64     `json:"fsGroup" desc:"Explicitly set the group ID for volume ownership. Default is 10101"`
	ExtraAccessLoggerLabels interface{} `json:"extraAccessLoggerLabels" desc:"Optional extra key-value pairs to add to the metadata.labels data of the gloo access logger pod."`
	*DeploymentSpec
}
...
type IngressDeployment struct {
	...
	RunAsUser          float64     `json:"runAsUser" desc:"Explicitly set the user ID for the container to run as. Default is 10101"`
	FloatingUserId     bool        `json:"floatingUserId" desc:"set to true to allow the cluster to dynamically assign a user ID"`
	ExtraIngressLabels interface{} `json:"extraIngressLabels" desc:"Optional extra key-value pairs to add to the metadata.labels data of the ingress pod."`
	*DeploymentSpec
}
...
type IngressProxyDeployment struct {
	...
	ExtraIngressProxyLabels interface{}       `json:"extraIngressProxyLabels" desc:"Optional extra key-value pairs to add to the metadata.labels data of the ingress proxy pod."`
	*DeploymentSpec
}
